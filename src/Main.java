public class Main {
    ...
    public static int numberOfVowels (String str){
        ...
        for (int i = 0; i < str.length(); i++){
            if (str.charAt(i)=='e'||str.charAt(i)=='i'||str.charAt(i)=='o'||str.charAt(i)=='a'||str.charAt(i)=='u'){
                result ++;
            }
    ...
    public static int notDivisibleBy235 (int one){
        int result = 0;
        for (int i = 0; i <one; i++){
    ...
    public static String camelCaseMe (String str){
        ...
        for (int i = 0; i < str.length(); i++){
            if (str.charAt(i)=='-'||str.charAt(i)=='_'&& i != str.length()-1){
                i++;
                String x = str.substring(i, i+1);
                x = x.toUpperCase();
                result+=x;
            }
            else if (str.charAt(i)=='-'||str.charAt(i)=='_'&& i == str.length()-1){
                i++;
            }
